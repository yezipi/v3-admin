    ...
    children: [
      {
        ...
        component: () => import(/* webpackChunkName: "AdSettings" */ '../views/Settings/Ad.vue'),
      },
      {
        path: '/MailSettings',
        name: 'MailSettings',
        meta: { title: '邮件设置', role: [1, 2], icon: 'el-icon-message' },
        component: () => import(/* webpackChunkName: "MailSettings" */ '../views/Settings/Mail.vue'),
      },
      {
        path: '/SecuritySettings',
        name: 'SecuritySettings',
        meta: { title: '安全设置', role: [1, 2], icon: 'el-icon-message' },
        component: () => import(/* webpackChunkName: "SecuritySettings" */ '../views/Settings/Security.vue'),
      },
      {
        path: '/CustomSettings',
        name: 'CustomSettings',
        meta: { title: '个性化设置', role: [1, 2], icon: 'el-icon-s-open' },
        component: () => import(/* webpackChunkName: "CustomSettings" */ '../views/Settings/Personalize.vue'),
      },
      {
        path: '/BaseSettings',
        name: 'BaseSettings',
        meta: { title: '基本设置', role: [1, 2], icon: 'el-icon-s-tools' },
        component: () => import(/* webpackChunkName: "BaseSettings" */ '../views/Settings/Base.vue'),
      },
    ],
  },
]
