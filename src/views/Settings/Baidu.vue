...
<template>
  <div class="mail-settings">
    <a-alert
      title="百度统计需要昨日pv大于100的站点才能开启"
      type="warning"
      show-icon
      style="margin-bottom: 15px"
    >
      前往百度统计管理->其他设置->数据导出服务进行开通
    </a-alert>
    <a-form ref="formRef" size="large" auto-label-width :model="ruleForm" :rules="rules">
      <a-form-item label="Key"  name="appid">
        <a-input v-model="ruleForm.appid" placeholder="百度统计的API Key"></a-input>
      </a-form-item>

      <a-form-item label="Secret"  name="secret">
        <a-input v-model="ruleForm.secret" placeholder="百度统计的Secret Key"></a-input>
      </a-form-item>

      <a-form-item label="code"  name="code">
        <div style="flex: 1">
          <div style="display: flex">
            <a-input v-model="ruleForm.code" placeholder="百度统计获取的code"></a-input>
      ...
      <a-form-item label="站点id"  name="site_id">
        <div style="flex: 1">
          <a-input v-model="ruleForm.site_id" placeholder="百度统计站点id"></a-input>
