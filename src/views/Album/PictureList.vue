<template>
  <div class="album-manage">
    <div class="am-top">
      <div class="am-filter">
        <a-select v-model:value="condition.album_id" :options="albums" style="width: 200px" placeholder="全部"></a-select>
    ...
    <div v-if="list.length" class="album-list">
      <ul>
        <li v-for="(item, k) in list" :key="k" class="al-item">
          <div class="al-cover">
            <div class="cover-bg" :style="{ background: `url(${item.thumb_path || defaultPic}) center` }"></div>
    ...
    <picture-edit v-model:visible="drawVisible" :albums="albums" :id="currId" @finish="getList"></picture-edit>
